...
'''
    1. Prep camera
    2. Load hand landmark model
    3. Open camera and detect mp hand
    4. Calculate landmarks
    5. Normalize coordinates
    6. Logging into csv file
    7. Draw detections
'''
...
def csvLogger(label, normalized):
    with open('handDataset.csv', 'a', newline='') as csvfile:
